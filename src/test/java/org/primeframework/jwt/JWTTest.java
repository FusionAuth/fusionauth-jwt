...
public class JWTTest {
  ...
  public void encoding_performance() throws Exception {
    ...
    Signer rsaSigner = RSASigner.newRSA256Signer(new String(Files.readAllBytes(Paths.get("src/test/resources/rsa_private_key_4096"))));
  ...
  public void test_RS256() throws Exception {
    JWT jwt = new JWT().with(t -> t.subject = "123456789");
    Signer signer = RSASigner.newRSA256Signer(new String(Files.readAllBytes(Paths.get("src/test/resources/rsa_private_key_4096"))));
  ...
  public void test_RS512() throws Exception {
    JWT jwt = new JWT().with(t -> t.subject = "123456789");
    Signer signer = RSASigner.newRSA512Signer(new String(Files.readAllBytes(Paths.get("src/test/resources/rsa_private_key_4096"))));
