...
public class VerifierTest {
  ...
  static {
    try {
      algorithms.add(new Pair<>(HMACVerifier.withSecret("secret"), "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkifQ.qHdut1UR4-2FSAvh7U3YdeRR5r5boVqjIGQ16Ztp894"));
      algorithms.add(new Pair<>(RSAVerifier.withPublicKey(new String(Files.readAllBytes(Paths.get("src/test/resources/rsa_public_key_4096.pem")))),
