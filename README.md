## FusionAuth JWT ![semver 2.0.0 compliant](http://img.shields.io/badge/semver-2.0.0-brightgreen.svg?style=flat-square) ![Tests (with Maven)](https://github.com/FusionAuth/fusionauth-jwt/workflows/Tests/badge.svg)
